...
val mvvmActivityTemplate
    get() = template {
        revision = 1
        name = "MvvmActivity ViewModel"
        description = "适用于Mvvm架构的Activity"
        minApi = MIN_API
        minBuildApi = MIN_API
...
//        thumb {File(ClassLoader.getSystemResource("com/github/see99/androidpluginh/otherx/mvvm/activity/haox.png").file)}
